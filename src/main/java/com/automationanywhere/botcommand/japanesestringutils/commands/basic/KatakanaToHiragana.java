...
/**
 *
 * Converts Katakana in the source string to Hiragana.
...
@CommandPkg(
		...
		name = "KatakanaToHiragana", label = "[[KatakanaToHiragana.label]]",
		node_label = "[[KatakanaToHiragana.node_label]]", description = "[[KatakanaToHiragana.description]]", icon = "StringIcon.svg",

		//Return type information. return_type ensures only the right kind of variable is provided on the UI. 
		return_label = "[[KatakanaToHiragana.return_label]]", return_type = STRING, return_required = true)
public class KatakanaToHiragana {
	...
	public Value<String> action(
			...
			//UI labels.
			@Pkg(label = "[[KatakanaToHiragana.targetString.label]]")
