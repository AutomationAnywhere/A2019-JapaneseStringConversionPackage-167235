...
/**
 *
 * Converts Hiragana in the source string to Katakana.
...
@CommandPkg(
		...
		name = "HiraganaToKatakana", label = "[[HiraganaToKatakana.label]]",
		node_label = "[[HiraganaToKatakana.node_label]]", description = "[[HiraganaToKatakana.description]]", icon = "StringIcon.svg",

		//Return type information. return_type ensures only the right kind of variable is provided on the UI. 
		return_label = "[[HiraganaToKatakana.return_label]]", return_type = STRING, return_required = true)
public class HiraganaToKatakana {
	...
	public Value<String> action(
			...
			//UI labels.
			@Pkg(label = "[[HiraganaToKatakana.targetString.label]]")
